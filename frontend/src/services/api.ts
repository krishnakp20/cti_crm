...
// NOTE: trailing slash on root list endpoints (router.get("/"))
// NO trailing slash on sub-routes (router.get("/templates")) to avoid 307 redirect dropping auth
...
export const alertsApi = {
  ...
  toggle: (id: number) => api.post(`/alerts/${id}/toggle`),
  ...
  toggleEscalation: (id: number) => api.post(`/alerts/escalations/${id}/toggle`),
}
